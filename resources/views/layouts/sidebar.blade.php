<ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if (auth()->user()->role == 'ba_intelkam')
            <li class="nav-item {{ request()->routeIs('user.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('user.index') }}">
                    <i class="{{ request()->routeIs('user.index') ? 'bi bi-people-fill' : 'bi bi-people' }}"></i>
                    <span>Users</span>
                </a>
            </li>
        @endif
    ...
    <li class="nav-item {{ request()->routeIs('status.index') || request()->routeIs('kesatuan.index') ? 'active' : '' }}">
        <a class="nav-link collapsed" data-bs-target="#master-data" data-bs-toggle="collapse" href="#">
            <i class="{{ request()->routeIs('status.index') || request()->routeIs('kesatuan.index') ? 'bi bi-menu-button-wide-fill' : 'bi bi-menu-button-wide' }}"></i>
            <span>Master Data</span>
            <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="master-data" class="nav-content collapse {{ request()->routeIs('status.index') || request()->routeIs('kesatuan.index') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
    ...
    <li class="nav-item {{ request()->routeIs('skck.input') || request()->routeIs('skck.output') || request()->routeIs('skck.broken') ? 'active' : '' }}">
        <a class="nav-link collapsed" data-bs-target="#data-skck" data-bs-toggle="collapse" href="#">
            <i class="{{ request()->routeIs('skck.input') || request()->routeIs('skck.output') || request()->routeIs('skck.broken') ? 'bi bi-file-text-fill' : 'bi bi-file-text' }}"></i>
            <span>Data SKCK</span>
            <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="data-skck" class="nav-content collapse {{ request()->routeIs('skck.input') || request()->routeIs('skck.output') || request()->routeIs('skck.broken') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
