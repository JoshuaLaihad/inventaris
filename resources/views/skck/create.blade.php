    ...
    <div class="card-body">
        <form action="{{ route('skck.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="kesatuan" name="kesatuan" class="form-control @error('kesatuan') is-invalid @enderror" value="{{ old('kesatuan') }}" required>
                @error('kesatuan')
            ...
            <div class="mb-3">
                ...
                <input type="text" id="no_box" name="no_box" class="form-control @error('no_box') is-invalid @enderror" value="{{ old('no_box') }}" required>
                @error('no_box')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="no_reg" name="no_reg" class="form-control @error('no_reg') is-invalid @enderror" value="{{ old('no_reg') }}" required>
                @error('no_reg')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
